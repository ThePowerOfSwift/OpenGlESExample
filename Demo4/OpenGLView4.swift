    ...
    private var slider1: UISlider {
        get{
            if _slider1 == nil{
                ...
                _slider1.tag = 1
                _slider1.addTarget(self, action: #selector(OpenGLView4.sliderValueChanged(_:)), forControlEvents: .ValueChanged)
            }
            return _slider1
        }
        set{
    ...
    private var slider2: UISlider {
        get{
            if _slider2 == nil{
                ...
                _slider2.tag = 2
                _slider2.addTarget(self, action: #selector(OpenGLView4.sliderValueChanged(_:)), forControlEvents: .ValueChanged)
            }
            return _slider2
        }
        set{
    ...
    private var slider3: UISlider {
        get{
            if _slider3 == nil{
                ...
                _slider3.tag = 3
                _slider3.addTarget(self, action: #selector(OpenGLView4.sliderValueChanged(_:)), forControlEvents: .ValueChanged)
            }
            return _slider3
        }
        set{
